"""
Django settings for nanowrimo project.
...
WSGI_APPLICATION = 'nanowrimo.wsgi.application'
...
DRF_AUTO_BASE_VIEWSET = 'nanowrimo.views.ModelViewSet'
DRF_AUTO_BASE_READONLY_VIEWSET = 'nanowrimo.views.ReadOnlyModelViewSet'
...
EXPORTER_ROUTER_PATH = 'nanowrimo.api_urls.router'
EXPORTER_FRONT_APPLICATION_NAME = 'nanowrimo'
